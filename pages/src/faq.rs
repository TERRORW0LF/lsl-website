      ...
      <section id="faq">
        ...
        <section id="codes">
          ...
          >
            ...
            <p>
              "The main code for Lucio Surf is "<strong>"KVKKR"</strong> ". To favorite the code click the "
              <span class="red">"star"</span> " button on a Lucio Surf lobby in your " "recently played tab."
            </p>
            <img src="/cdn/faq/favorite.jpg" alt="Favorite button" />
            <p>
              "After favoriting the code go to the Favorites tab and select " <strong>"Lucio Surf"</strong>
              ". To join a lobby use the " <span class="red">"Quick Join"</span>" button " "or double click "
              <strong>"Lucio Surf"</strong> " and select a specific lobby and click " <span class="red">"Join"</span>"."
              "To create your own lobby instead, click the " <span class="blue">"Create New Lobby"</span>" button."
            </p>
            <div class="row">
            ...
            <p>
              ...
              "you open a lobby. Create a custom game and click the " <span class="red">"Import"</span>
            ...
            <p>
              ...
              "will not be accepted as outlined in the " <a href="#submit">"submit rules"</a>"."
            </p>
            <div class="spacing"></div>
            <h5>"Beta participation"</h5>
            <p>
              "If you want to test out changes early, we recommend the beta code " <strong>"048YZ"</strong>
              ". Feedback is welcome and can be provided over our " <A href="/discord" target="_blank">
                "discord server"
              </A>". Submits of runs achieved on the beta code " "will not be accepted to the leaderboards."
            </p>
          </Collapsible>
        </section>
        <hr />
        <section id="codes">
          ...
          >
            ...
            <p>
              ...
              " account dropdown and fill out the form. "<strong>"Code"</strong> " is a shorthand for "
              <strong>"Layout"</strong>", " <strong>"Category"</strong>", and " <strong>"Map"</strong>
              " which will be autofilled when typing in the code. The " <strong>"Video ID"</strong>
              " field are the 11 characters indentifying the proof video on YouTube:"
            </p>
            <ul>
              <li>"https://www.youtube.com/watch?v="<strong>"dQw4w9WgXcQ"</strong></li>
