    ...
    let titles = vec![
        (
            ...
            Signal::<String>::derive(move || match patch.get().as_str() {
                ...
                "2.13" => format!("{} or more rating points", if layout.get().is_none() { 300 } else { 500 }),
        ...
        (
            ...
            Signal::<String>::derive(move || match patch.get().as_str() {
                ...
                "2.13" => format!("{} or more rating points", if layout.get().is_none() { 600 } else { 1500 }),
                _ => "Unknown patch selected".into(),
            }),
        ),
        (
            ...
            Signal::<String>::derive(move || match patch.get().as_str() {
                ...
                "2.13" => format!("{} or more rating points", if layout.get().is_none() { 1000 } else { 3000 }),
                _ => "Unknown patch selected".into(),
            }),
        ),
        (
            ...
            Signal::<String>::derive(move || match patch.get().as_str() {
                ...
                "2.13" => format!("{} or more rating points", if layout.get().is_none() { 3000 } else { 6000 }),
                _ => "Unknown patch selected".into(),
            }),
        ),
        (
            ...
            Signal::<String>::derive(move || match patch.get().as_str() {
                ...
                "2.13" => format!("{} or more rating points", if layout.get().is_none() { 5000 } else { 8000 }),
                _ => "Unknown patch selected".into(),
            }),
        ),
